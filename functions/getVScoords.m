function VScoords = getVScoords(VSarray)
%%GETVSCOORDS receives a VSource array and returns a matrix of current
%%source coordinates.
%
% Input parameters:
...
%
% Output parameters:
%   VScoords - Matrix of coordinates (each column corresponds to a source).
%
% See also: VSource.
%
%*****************************************************************************
...
%*****************************************************************************
    ...
    aux = cellfun(@(x) x.coord, VSarray,  'UniformOutput', false);
    VScoords = cell2mat(aux).';
end