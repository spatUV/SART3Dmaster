function [f] = GUIstart_new(v)
%%GUISTART starts main figure GUI
%
% Output parameter:
%   f   -   Handle to figure GUI
%
% See also: SART3D.
...
f = figure('Visible', 'on', 'Position', v.bounds, 'Color', v.bgColor,...
    'Name', 'SART-3D (3D Spatial Audio Rendering Toolbox)',...
    'NumberTitle', 'off', 'MenuBar', 'none', 'CloseRequestFcn', @gEnd);
